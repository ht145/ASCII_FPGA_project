...
set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports {D[3]}];  #JC1     
set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS33} [get_ports {D[2]}];  #JC2
set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports {D[1]}];  #JC3
set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS33} [get_ports {D[0]}];  #JC4
#set_property -dict {PACKAGE_PIN E7 IOSTANDARD LVCMOS33} [get_ports {D[3]}]
#set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports {D[2]}]
#set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports {D[1]}]
#set_property -dict {PACKAGE_PIN E6 IOSTANDARD LVCMOS33} [get_ports {D[0]}]

##Pmod Header JD

set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports sioc];    #JD1
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports siod];    #JD2    
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports VSYNC];   #JD3
set_property -dict {PACKAGE_PIN G3 IOSTANDARD LVCMOS33} [get_ports HREF];    #JD4
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports PCLK];    #JD7
set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports CamCLK];  #JD8
#set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports rst]
#set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports pwdn]

##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { Aout[0] }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { Aout[1] }]; #IO_L14N_T2_SRCC_15 Sch=jb[2]
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { Aout[2] }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { WriteEnable }]; #IO_L15P_T2_DQS_15 Sch=jb[4]
set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { dout[0]  }]; #IO_L11N_T1_SRCC_15 Sch=jb[7]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { dout[1] }]; #IO_L5P_T0_AD9P_15 Sch=jb[8]
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { dout[2] }]; #IO_0_15 Sch=jb[9]
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { dout[3] }]; #IO_L13P_T2_MRCC_15 Sch=jb[10]

##more clk stuff
set_false_path -from [get_clocks clk_core ] -to [get_clocks clk_31_5* ]
set_false_path -from [get_clocks clk_31_5*] -to [get_clocks clk_core ]
